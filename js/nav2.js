$(document).ready(function() {
  ...
  $(".dropdown-menu-1").append('<li><a href="https://bccandataanalytics.shinyapps.io/IncidenceCrudeRates" target="_blank">BC: Crude Incidence Rates</a></li>');
  ...
  $(".dropdown-menu-1").append('<li><a href="https://bccandataanalytics.shinyapps.io/StandardizedIncidenceRatio/" target="_blank">Age-standardized Cancer Incidence Ratio</a></li>');
  ...
  $(".dropdown-menu-2").append('<li><a href="https://bccandataanalytics.shinyapps.io/MortalityCrudeRates" target="_blank">BC: Crude Death Rates</a></li>');
  ...
  $(".dropdown-menu-2").append('<li><a href="https://bccandataanalytics.shinyapps.io/StandardizedMortalityRatio/" target="_blank">Age-standardized Cancer Mortality Ratio</a></li>');
  ...
  $(".dropdown-menu-5").append('<li><a href="https://bccandataanalytics.shinyapps.io/LifetimeRisk/" target="_blank">Lifetime Risk</a></li>');
  $(".dropdown-menu-6").append('<li><a href="https://bccandataanalytics.shinyapps.io/IncidCreateYourOwnTable/" target="_blank">BC: New Cancer Diagnoses</a></li>');
  $(".dropdown-menu-6").append('<li><a href="https://bccandataanalytics.shinyapps.io/MortCreateYourOwnTable/" target="_blank">BC: Cancer Deaths</a></li>');
  /*$(".dropdown-menu-5").append('<li><a href="https://bccandataanalytics.shinyapps.io/SurvivalRate/" target="_blank">Survival Rate</a></li>');*/
