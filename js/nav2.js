$(document).ready(function() {
  ...
  $(".dropdown-menu-1").append('<li><a href="https://bccandataanalytics.shinyapps.io/RegionalIncidenceCounts/" target="_blank">BC: Regional Incidence</a></li>');
  ...
  $(".dropdown-menu-3").append('<li><a href="https://bccandataanalytics.shinyapps.io/RegionalPrevalenceCounts/" target="_blank">BC: Regional Prevalence</a></li>');
